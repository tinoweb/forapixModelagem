...
// Adicionar configurações específicas do ForaPix
$forapixConfig = "

# ForaPix Specific
FORAPIX_ADMIN_EMAIL=admin@forapix.com
FORAPIX_ADMIN_PASSWORD=Admin@2024!
FORAPIX_MIN_BET=1.00
FORAPIX_MAX_BET=10000.00
FORAPIX_COMMISSION=0.05
...
# CORS Settings
SANCTUM_STATEFUL_DOMAINS=forapix.com,localhost:8080
SESSION_DOMAIN=.forapix.com
";
...
echo "✅ Configurações específicas do ForaPix adicionadas!\n";
